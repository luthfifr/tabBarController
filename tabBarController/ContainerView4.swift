...
class ContainerView4: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 0 ..< posterFilm.count {
            ...
            self.scrollView4.addSubview(curr_imageView)
        }
        
        self.scrollView4.contentSize = CGSize(width: imageViews[imageViews.count-1].frame.size.width+imageViews[imageViews.count-1].frame.origin.x+CGFloat(ukuranXgambar), height: self.scrollView4.frame.size.height)
    }
